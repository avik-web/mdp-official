...
export const BackgroundLines = ({
  ...
  return (
    <div
      className={cn(
        "h-[20rem] md:h-screen w-full bg-white dark:bg-black overflow-hidden relative",
        className
      )}
    >
...
// Animated blurred circles for extra visual interest
  ...
  return (
    <div className="absolute inset-0 w-full h-full z-0 pointer-events-none">
      {circles.map((circle, i) => (
        <motion.div
          key={i}
          className={`absolute rounded-full blur-3xl opacity-60 ${circle.className}`}
          style={{
            width: circle.size,
            height: circle.size,
            top: circle.top,
...
const SVG = ({
  ...
  const paths = [
    ...
    "M720 450C720 450 712.336 437.768 690.248 407.156C668.161 376.544 672.543 394.253 665.951 365.784C659.358 337.316 647.903 347.461 636.929 323.197C625.956 298.933 626.831 303.639 609.939 281.01C593.048 258.381 598.7 255.282 582.342 242.504C565.985 229.726 566.053 217.66 559.169 197.116C552.284 176.572 549.348 171.846 529.347 156.529C509.345 141.211 522.053 134.054 505.192 115.409C488.331 96.7642 484.219 98.7152 467.114 79.8092C450.009 60.9032 441.185 66.9842 423.529 50.9582C405.873 34.9312 400.502 44.4032 371.912 26.2412C343.323 8.07819 353.288 10.8902 317.03 1.71419C280.772 -7.46181 287.621 -9.89081 268.253 -25.2858C248.886 -40.6808 235.493 -41.0258 216.965 -47.6858C198.437 -54.3458 193.9 -61.2958 164.776 -73.2998C135.652 -85.3038 140.867 -89.7338 113.835 -98.0918",
